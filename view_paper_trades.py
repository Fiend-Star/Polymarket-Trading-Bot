...
def display_paper_trades(trades):
    ...
    print("-" * 100)
    print(
        f"{'#':<4} {'Time':<20} {'Direction':<10} {'Size':<12} {'Price':<12} {'Score':<8} {'Confidence':<12} {'Outcome':<10}")
    print("-" * 100)
    ...
    for i, trade in enumerate(trades, 1):
        ...
        print(
            f"{i:<4} {timestamp:<20} {direction:<10} {size:<12} {price:<12} {score:<8} {confidence:<12} {outcome:<10}")
